...
| 2026-08-24 | "最大的问题是你的用词(名词/谓语选用):随行注意、踩在、未销账目标这类。正常说需注意、待做目标就行。你先去 github 看看有没有强制让你转化表达的词库,没有的话我们自己搭一套——看你说话太费劲,总要转化你用词的原始含义,直接一步到位最好。" | Tony 原话(本会话) | open — 调研完成(`docs/superpowers/research/2026-08-24-plain-word-lexicon.md`):无现成中文词库,格式借 prh、注入走 speak-human 既有通道;词库草案 v0 待 Tony 圈选词条 |
