...
1. 引用规则名、文件名、章节名:整体括在「」或反引号里、能指认出处的才算引用
   (如 P9「拍板对象先上桌」);散在句子里当普通动词、名词用,不豁免。
2. 转述用户原话、引用文档原文、或讨论某个词本身时,照原文写。
3. 用户本轮对话里自己先用了某词,回答时可跟随该词对齐指称;自己主动开口仍用
   平实词。
4. 该词是所在领域被指称对象的正式名称(财务的台账、网络的数据链路层、控制系统
...
9. 删过一遍了吗?留下的每句,外行读者能说出自己会得到什么吗?(P1/P7/P2/P5/P9
   要求的事实照留)(S4)
10. 用词都是平实词吗?词库左列的词零出现,其他要读者翻译一遍的比喻词/行话也都
    换掉了吗?(S5)
...
词库的多变体映射结构借鉴 [prh/prh](https://github.com/prh/prh)(MIT),词条内容全部自建。
